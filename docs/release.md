...
- `release-crates.yml` publishes `rebecca-core`, `rebecca-rules`, `rebecca-windows`, and `rebecca` to crates.io in dependency order.

## Artifact Names

For tag `v0.1.1`, cargo-dist currently publishes:
