...
- In progress: Steam discovery and cleanup hardening continue after the Steam cleanup expansion slice; the latest follow-up collapsed the Steam planner and CLI regression coverage into table-driven tests and refreshed the Steam user-facing docs to keep the catalog boundaries explicit.
- Blocked: None.
