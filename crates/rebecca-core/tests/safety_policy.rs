...
fn catalog_target_shapes_keep_known_maintenance_targets_open() {
    ...
    for target in [
        ...
        RuleTargetSpec::glob_template("/var/cache/apt/archives/*.deb"),
        RuleTargetSpec::glob_template("/var/cache/dnf/*/packages"),
        RuleTargetSpec::glob_template("/var/cache/pacman/pkg/*.pkg.tar.*"),
        RuleTargetSpec::glob_template("/var/cache/zypp/packages/*/*/*.rpm"),
        RuleTargetSpec::steam_install_template("appcache/httpcache"),
