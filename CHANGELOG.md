...
- Experimental NTFS/MFT cleanup estimates still keep cleanup byte totals on logical unnamed `$DATA` streams, while disk-map surfaces can now expose parser-backed allocated and unique physical metrics when available.
