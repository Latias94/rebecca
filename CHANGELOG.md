...
- The TUI confirmation screen now shows the cleanup destination, selected rules, target counts, estimated space, safety gates, and follow-up trash commands before accepting the final typed confirmation.
