...
- `scripts/ntfs/run-live-mft-dogfood.ps1` now emits top-level backend comparison summaries with portable-baseline match status, metric deltas, duration ratios, fastest backend, and bounded diagnostic summary totals.
