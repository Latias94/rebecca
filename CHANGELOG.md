...
- Experimental NTFS/MFT volume-index caching now writes versioned `MftIndex` payload files beside configured manifests and can reuse them only after live USN freshness validation proves the volume did not change since the full-index build.
